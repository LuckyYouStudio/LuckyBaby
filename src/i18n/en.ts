...
export const en: Record<string, string> = {
  ...
  '没收到？看看垃圾邮件；一小时内最多发 2 封。': 'Nothing yet? Check spam. At most 2 emails per hour.', '换手机或重装后，用同一个邮箱就能找回。': 'On a new phone or after reinstalling, the same email brings everything back.', '用邮箱绑定': 'Link with email',
