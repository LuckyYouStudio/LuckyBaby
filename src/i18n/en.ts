...
export const en: Record<string, string> = {
  ...
  // 只记经期
  '乳房胀': 'Breast tenderness', '头痛': 'Headache', '长痘': 'Breakouts', '食欲大': 'Cravings', '情绪低': 'Low mood', '腹胀': 'Bloating',
  '月经期': 'Period', '卵泡期': 'Follicular phase', '排卵期': 'Ovulation window', '黄体期': 'Luteal phase', '经前期': 'PMS days', '月经推迟': 'Period late',
  '注意保暖，少碰生冷；痛得厉害可以记下来，方便和医生说。': 'Keep warm, skip cold food; log bad cramps so you can tell your doctor.',
  '身体状态通常最好的一段时间，适合安排运动和重要的事。': 'Usually your best-feeling days; good for workouts and big tasks.',
  '这几天是排卵期，分泌物会变多变透明，属于正常现象。': 'Ovulation window; clearer, stretchier discharge is normal.',
  '可能会有点胀或困，不用担心。': 'You may feel a bit bloated or sleepy; that\'s normal.',
  '月经快来了，情绪波动、乳房胀、长痘都常见。早点睡，少喝咖啡。': 'Period is near; mood swings, tender breasts and breakouts are common. Sleep early, go easy on coffee.',
  '推迟几天很常见，压力、熬夜、换环境都会影响。超过一周还没来，可以验个孕或问问医生。': 'A few days late is common; stress, late nights and travel all matter. Over a week late, take a test or ask a doctor.',
  '{mom} 的经期记录': '{mom}\'s cycle', '经期记录': 'Cycle tracking', '她这几天在经期，多体谅一点，热水袋和热饮备着。': 'She is on her period; be gentle, keep a hot-water bottle and warm drinks ready.',
  '她的月经快来了（预计 {d}），情绪起伏是正常的。': 'Her period is due {d}; mood swings are normal.', '下次月经预计 {d}。': 'Next period expected {d}.', '经期的具体记录只有她自己和伴侣能看到。': 'Cycle details are visible only to her and her partner.',
  '距下次月经 {n} 天': '{n} days to next period', '开始记录经期': 'Start tracking', '有了这一天，就能预测下次月经和排卵期。': 'With that date we can predict your next period and ovulation.',
  '排卵期 {a}–{b} · 经前期约从 {c} 起': 'Ovulation {a}–{b} · PMS from about {c}', '最近几次周期长短差得多，预测误差会比较大。': 'Recent cycles vary a lot, so predictions are rough.',
  '量少': 'Light', '量中': 'Medium', '量多': 'Heavy', '经量': 'Flow', '微痛': 'Mild', '痛': 'Cramps', '很痛': 'Severe', '痛经': 'Cramps',
  '经量和痛经多点几下可以换档：少 / 中 / 多，微痛 / 痛 / 很痛。': 'Tap flow or cramps again to change level: light / medium / heavy, mild / cramps / severe.', '经量 / 痛经': 'Flow / cramps',
  '开始备孕？': 'Start trying to conceive?', '切换后首页会显示易孕期和最佳时机，并加上孕前检查和叶酸提醒。经期记录都保留。': 'Home will show the fertile window and best days, plus a pre-pregnancy checkup and folic acid reminders. Your cycle history stays.',
  '预测按平均周期估算，周期不规律时误差较大。排卵期只作参考，不能用于避孕；有疑问请咨询医生。': 'Predictions use your average cycle; irregular cycles reduce accuracy. The ovulation window is a reference only, not contraception. Ask your doctor if unsure.',
  '你好': 'Hi', '我自己用': 'For myself', '怀孕 / 备孕 / 记经期': 'Pregnant / TTC / cycle', '自己一个人用就行，不需要邀请任何人。以后想让伴侣知道你哪几天不舒服，再发邀请码给他。': 'Use it on your own; no need to invite anyone. Share an invite code later if you want your partner to know your rough days.',
  '产检、用药': 'Checkups, meds', '只记经期': 'Just my cycle', '一个人也能用': 'Solo is fine',
  '不确定就先填 28 和 5，记两个周期后会自动按你的实际周期算。以后想备孕或怀上了，一键切换，记录都还在。': 'Not sure? Use 28 and 5; after two cycles we use your real numbers. Switch to TTC or pregnancy later with one tap; your history stays.',
