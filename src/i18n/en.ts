...
export const en: Record<string, string> = {
  ...
  '开始之前': 'Before you start', '这个 App 会保存你记录的孕期健康信息（产检结果、体重、症状、用药等）。这类信息属于敏感个人信息，需要你单独同意我们才会处理。': 'This app stores the pregnancy health information you record (checkup results, weight, symptoms, medication). This is sensitive personal information, and we only process it with your separate consent.',
